...
import { Search, Bell, ChevronDown, User, LogOut, Settings, FlaskConical } from 'lucide-react';

const NAV = [
  { label: 'Dashboard',       href: '/laboratorio'               },
  { label: 'Control Calidad', href: '/laboratorio/control-calidad' },
  { label: 'Auditoría',       href: '/laboratorio/auditoria'     },
];
...
export default function LaboratorioNavbar({ alertCount = 2 }: LaboratorioNavbarProps) {
    ...
    <nav className="bg-white border-b border-gray-100 px-6 h-16 flex items-center justify-between sticky top-0 z-40">
      ...
      <div className="flex items-center gap-2 min-w-[180px]">
        ...
        <div>
          ...
          <p className="text-[10px] text-gray-400 leading-tight">Laboratorio Clínico</p>
        </div>
      </div>
      ...
      <div className="flex-1 max-w-sm mx-6">
        <div className="relative">
          ...
          <input
            ...
            placeholder="Buscar orden, DNI o paciente…"
      ...
      <div className="flex items-center gap-0.5">
        {NAV.map(({ label, href }) => {
          const active = pathname === href || (href !== '/laboratorio' && pathname.startsWith(href));
          return (
            <Link
              key={href}
              href={href}
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden md:block text-left">
              <p className="text-xs font-semibold text-gray-700 leading-tight">María Torres</p>
              <p className="text-[10px] text-gray-400 leading-tight">Tecnóloga Médica</p>
            </div>
